...
export const Highlight = (props: HighlightProps) => {
  ...
  return (
    <HStack spacing='24px' {...rest}>
      ...
      <Text color='brand.richBlack' textAlign='left' fontSize='18' fontWeight='700'>{children}</Text>
    </HStack>
  )
}
function Highlights () {
  return (
    <Box maxW='1024px' m='auto' pt='60px' pb='32px'>
      <HStack px='48px' spacing='20px'>
        ...
        <Highlight icon={TimeIcon}>Flexible schedule for 1:1 training</Highlight>
